...
import MessageSelector from "./components/message-selector/message-selector";
...
function App() {
  ...
  return (
    <div className="App font-poppins md:flex ">
      <Navbar active={active} setActive={setActive} messageTrigger={setMessageTrigger} />
      <div className="">
        <button
          type="button"
      ...
      >
        {isChatsVisible ? <Header systemMessageTrigger={messageTrigger} /> : <GptIntro />}
        {isChatsVisible && <Chats />}
        {!isChatsVisible && <MessageSelector />}
        <div
